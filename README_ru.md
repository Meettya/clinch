...
Возможно в скором времени появится настройка, которая будет управлять инжектом и можно будет оставить глобальное пространство чистым, используя привязку, положим, виджетов к `data-attribute`.
