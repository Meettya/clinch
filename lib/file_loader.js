...
(function() {
  var FileLoader, LRU, async, fs, path, queueSomeRequest, rejectOnInvalidFilenameType, _;
  ...
  module.exports = FileLoader = (function() {
    var MAX_AGE;
    ...
    FileLoader.prototype.isFileExists = rejectOnInvalidFilenameType(function(filename, cb) {
      return fs.exists(filename, cb);
    });
    ...
    FileLoader.prototype.getFileWithMeta = rejectOnInvalidFilenameType(queueSomeRequest(function(filename, cb) {
      var cached_file;
    ...
    FileLoader.prototype.readCachedFileDigest = rejectOnInvalidFilenameType(queueSomeRequest(function(filename, cb) {
      var cache_fail, cached_file;
      cache_fail = (function(_this) {
        return function() {
          return _this._digest_calculator_.readFileDigest(filename, cb);
        };
      })(this);
      if (!this._file_cache_.has(filename)) {
        return cache_fail();
      ...
      return this.readFileMeta(filename, (function(_this) {
        return function(err, meta) {
          ...
          if (cached_file.meta.mtime === meta.mtime) {
            return cb(null, cached_file.digest);
          } else {
            return cache_fail();
          }
        };
