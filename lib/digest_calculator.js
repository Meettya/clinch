...
(function() {
  var DigestCalculator, crypto, fs, rejectOnInvalidFilenameType, shorthash, _;
  ...
  DigestCalculator = (function() {
    ...
    */
    ...
    DigestCalculator.prototype.readFileDigest = rejectOnInvalidFilenameType(function(filename, cb) {
      var hasher, stream;
