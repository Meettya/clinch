...
(function() {
  ...
  Gatherer = (function() {
    ...
    function Gatherer(_digest_calculator_, _file_processor_, _options_) {
      var _ref;
    ...
    Gatherer.prototype.buildModulePack = function(path_name, options, main_cb) {
      ...
      step_cache_name = this._digest_calculator_.calculateDataDigest(path_name + util.inspect(options));
      ...
      return this._getChangedFiles(probably_res.names_map, (function(_this) {
        return function(err, changed_list) {
          if (!changed_list.length) {
            ...
            return _this._reBuildModulePack(changed_list, step_cache_name, options, function(err, new_data) {
    ...
    Gatherer.prototype._reBuildModulePack = function(changed_list, step_cache_name, options, main_cb) {
      var map_fn;
    ...
    Gatherer.prototype._getChangedFiles = function(names_map, cb) {
      ...
      some_fn = (function(_this) {
        return function(file, acb) {
          return _this._digest_calculator_.readFileDigest(file, function(err, res) {
            if (err != null) {
              return acb(false);
            }
    ...
    Gatherer.prototype._findRequiresAndAddToQueue = function(_arg) {
      var child, childrens, composite_digest, content, digest, err, may_have_reqire, pack_cache, path_name, real_file_name, res, waterfall_cb, _i, _len, _ref;
