...
(function() {
  ...
  Gatherer = (function() {
    ...
    function Gatherer(_digest_calculator_, _file_processor_, _options_) {
      ...
      this._hardCacheProbe = __bind(this._hardCacheProbe, this);
      this._checkCachedFiles = __bind(this._checkCachedFiles, this);
    ...
    Gatherer.prototype._checkCachedFiles = function(names_map, cb) {
      var some_fn, vec;
      ...
      return async.some(vec, some_fn, function(result) {
    ...
    Gatherer.prototype._hardCacheProbe = function(path_name, options, step_cache_name, cb) {
      var probably_res;
      if (this._hard_cache_.has(step_cache_name)) {
        probably_res = this._hard_cache_.get(step_cache_name);
        return this._checkCachedFiles(probably_res.names_map, (function(_this) {
          return function(err, res) {
            if (err != null) {
              return cb(err);
            }
            if (res) {
              return cb(null, probably_res);
            } else {
              return cb(null, null);
            }
          };
    ...
    Gatherer.prototype.buildModulePack = function(path_name, options, main_cb) {
      ...
      return this._hardCacheProbe(path_name, options, step_cache_name, (function(_this) {
        return function(err, res) {
          if (err != null) {
            return main_cb(err);
          }
          if (res) {
            return main_cb(null, _.cloneDeep(res));
          }
          return _this._buildModulePack(path_name, options, step_cache_name, main_cb);
        };
      })(this));
    };
      ...
      load_queue.drain = (function(_this) {
        return function() {
          ...
          if (!pack_cache.err) {
            ...
            _this._hard_cache_.set(step_cache_name, _.cloneDeep(res));
