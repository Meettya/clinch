  ...
  Gatherer = (function() {
    ...
    function Gatherer(_file_processor_, _options_) {
      ...
      this._findRequiresAndAddToQueue = function(_arg) {
        var content, may_have_reqire, pack_cache, path_name, real_file_name;
        may_have_reqire = _arg.may_have_reqire, content = _arg.content, real_file_name = _arg.real_file_name, path_name = _arg.path_name, pack_cache = _arg.pack_cache;
    ...
    */
    ...
    Gatherer.prototype._findRequiresAndAddToQueue = function(_arg) {
      var child, childrens, content, may_have_reqire, pack_cache, path_name, real_file_name, res, _i, _len;
      may_have_reqire = _arg.may_have_reqire, content = _arg.content, real_file_name = _arg.real_file_name, path_name = _arg.path_name, pack_cache = _arg.pack_cache;
      if (may_have_reqire === true && this._isFilesMustBeProcessed(pack_cache.requireless, path_name)) {
        childrens = !this._require_cache_.has(real_file_name) ? (res = this._findRequiresItself(content), this._require_cache_.set(real_file_name, res), res) : this._require_cache_.get(real_file_name);
