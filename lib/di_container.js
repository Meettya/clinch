...
(function() {
  ...
  module.exports = DIContainer = (function() {
    ...
    DIContainer.prototype.addComponentsSettings = function() {
      var component_name, deep_walker, i, last_path_idx, new_value_obj, path, up_key;
      component_name = arguments[0], path = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), new_value_obj = arguments[i++];
      ...
      deep_walker = function(accumulator, step_val, idx) {
        var j, key, len, ref, ref1, results, value;
        if (accumulator[step_val] == null) {
          accumulator[step_val] = {};
        }
        if (idx === last_path_idx) {
          ref = _.pairs(new_value_obj);
          results = [];
