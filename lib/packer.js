  ...
  Packer = (function() {
    ...
    */
    ...
    Packer.prototype.buldPackage = function(package_config, main_cb) {
      var _this = this;
      return this._readSupportFiles(function(err, files_data) {
        if (err) {
          return main_cb(err);
        }
    ...
    */
    ...
    Packer.prototype._assemblePackage = function(package_code, package_config) {
      ...
      result = this._getHeader(env_header, package_config.strict);
      result += this._getDependencies(package_code.dependencies_tree);
      result += this._getSource(package_code.source_code);
      result += this._getBoilerplateJS();
      result += this._requireResolver();
      result += "\n" + env_body;
    ...
    */
    ...
    Packer.prototype._getHeader = function(env_header, strict_settings) {
      return "// Generated by clinch " + this._clinch_verison_ + "\n(function() {\n  " + (this._getStrictLine(strict_settings)) + "\n  " + env_header + "\n  var dependencies, sources, require;";
    };
    ...
    */
    ...
    Packer.prototype._getBoilerplateJS = function() {
      if (this._settings_.runtime) {
        return "if(this.clinch_runtime == null) {\n  throw Error(\"Resolve clinch runtime library first!\");\n}\nif(this.clinch_runtime.version == null || this.clinch_runtime.version != " + RUNTIME_TARGET_VERSION + ") {\n  throw Error(\"Runtime library version missmatch - need |" + RUNTIME_TARGET_VERSION + "|, but got |\" + this.clinch_runtime.version + \"| version.\" );\n}\n";
      } else {
    ...
    */
    ...
    Packer.prototype._requireResolver = function() {
      var prefix;
      prefix = this._settings_.runtime ? 'this.' : '';
