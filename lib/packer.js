  ...
  Packer = (function() {
    ...
    */
    ...
    Packer.prototype._getVariableDefinitions = function(isCached) {
      ...
      return "var dependencies, sources, require" + (isCached ? ", modules_cache = {}" : void 0) + ";";
    };
    ...
    */
    ...
    Packer.prototype._requireResolver = function() {
      ...
      modules_cache_string = this._settings_.cache_modules ? ', modules_cache' : '';
